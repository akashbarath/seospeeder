    ...
    <div className="flex items-center justify-center w-full antialiased">
      <div className="group relative w-full max-w-xl overflow-hidden rounded-3xl sm:rounded-4xl border bg-card shadow-2xl shadow-primary/5 transition-all duration-500 hover:shadow-primary/10 hover:-translate-y-1 m-0">
        <div className="p-4 sm:p-6 space-y-1.5 z-10 relative">
          ...
          <p className="text-lg sm:text-2xl text-foreground font-medium leading-snug max-w-[480px] font-inter font-semibold">
            ...
            <div className="flex flex-1 overflow-hidden">
                  ...
                  {TABS.map((tab) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        />
                        <span className="truncate z-20 relative font-semibold font-inter">
                          {tab.label}
                        </span>
                        {tab.badge && (
                          <span
                            className={cn(
                              "ml-auto text-[8px] leading-none py-0.5 px-1 rounded-md tabular-nums transition-all z-20 relative font-inter font-medium",
                              isActive
              ...
              <div className="flex-1 bg-background p-5 pt-6 flex flex-col gap-4 overflow-hidden relative">
                <header className="flex flex-col gap-0.5">
                  ...
                  <p className="text-[10px] text-muted-foreground font-normal leading-tight line-clamp-1 font-inter font-medium">
    ...
    <div className="grid grid-cols-2 gap-3">
      {[
        ...
        >
          ...
          <button className="w-fit flex items-center gap-1.5 px-2 py-1 rounded-md bg-foreground text-background text-[8px] font-bold transition-transform active:scale-95 group-hover:bg-primary z-10 font-inter">
